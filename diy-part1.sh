...
# echo 'src-git passwall https://github.com/esirplayground/Lienol-obsolete' >>feeds.conf.default
echo 'src-git media https://github.com/kenzok8/openwrt-packages' >>feeds.conf.default
